...
const RealDashboardPreview = () => {
  return (
    <div className="w-full max-w-[380px] mx-auto bg-[#050505] rounded-[3rem] border-[10px] border-[#1A1A1A] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.8)] relative aspect-[9/18.5]">
      ...
      <div className="pt-10 px-6 flex justify-between items-center text-[12px] font-bold tracking-tight">
        <div className="flex gap-2">
          <span className="bg-white/5 px-2.5 py-1 rounded text-white/70 border border-white/5 uppercase">NÍVEL 17</span>
      ...
      <div className="p-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-[13px] text-white/60 font-bold uppercase tracking-widest leading-none mb-1.5">OLÁ,</p>
      ...
      <div className="px-6 space-y-5 h-[calc(100%-160px)] overflow-y-auto scrollbar-hide pb-28">
        <div>
          ...
          <p className="text-xs text-white/60 mt-1.5 font-medium">Bem-vindo de volta ao seu centro de comando financeiro.</p>
        </div>

        <button className="w-full py-4 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-center gap-2.5 text-xs font-bold text-white/90 hover:bg-white/10 transition-colors uppercase tracking-[0.15em]">
          <FileText size={16} />
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 bg-[#0A0A0A] rounded-[2rem] border border-white/5 flex items-center justify-between group hover:border-vorix-orange/30 transition-all cursor-pointer">
            <div>
              <p className="text-[12px] text-white/60 font-bold uppercase tracking-widest mb-1.5">Saldo Total</p>
          ...
          <div className="p-5 bg-[#0A0A0A] rounded-[2rem] border border-white/5 flex items-center justify-between">
            <div>
              <p className="text-[12px] text-white/60 font-bold uppercase tracking-widest mb-1.5">Entradas (Mês)</p>
              <div className="flex items-center gap-2.5">
                <h4 className="text-xl font-bold text-emerald-500 font-mono">R$ 83,00</h4>
                <span className="text-[12px] px-1.5 py-0.5 bg-emerald-500/10 text-emerald-500 rounded-md font-black">↑ 12%</span>
              </div>
            </div>
          ...
          <div className="p-5 bg-[#0A0A0A] rounded-[2rem] border border-white/5 flex items-center justify-between">
            <div>
              <p className="text-[12px] text-white/60 font-bold uppercase tracking-widest mb-1.5">Saídas (Mês)</p>
              <div className="flex items-center gap-2.5">
                <h4 className="text-xl font-bold text-red-500 font-mono">R$ 932,00</h4>
                <span className="text-[12px] px-1.5 py-0.5 bg-red-500/10 text-red-500 rounded-md font-black">↓ 5%</span>
              </div>
            </div>
          ...
          <div className="p-6 bg-[#0A0A0A] rounded-[2rem] border border-white/5">
            <h5 className="text-[13px] font-bold mb-6 uppercase tracking-[0.2em] text-white/70">Fluxo de Caixa</h5>
            ...
            <div className="flex justify-between mt-5 text-[10px] font-black text-white/50 uppercase tracking-widest px-1">
           ...
           <div className="p-6 bg-[#0A0A0A] rounded-[2rem] border border-white/5">
            <h5 className="text-[13px] font-bold mb-6 uppercase tracking-[0.2em] text-white/70">Distribuição de Despesas</h5>
            <div className="flex items-center gap-6">
               <div className="relative w-20 h-20">
                 ...
                 <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[10px] font-bold">R$ 932</span>
                 </div>
               </div>
