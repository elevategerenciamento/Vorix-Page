      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-bold mb-6 max-w-2xl leading-tight">
            Gestão inteligente para quem <span className="text-vorix-orange text-white/60">não tem tempo a perder.</span>
          </h2>

          <div className="flex flex-wrap justify-center gap-6 md:gap-12 mb-12 text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-white/50">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-12 border-t border-white/5 w-full justify-between">
            <p className="text-white/20 text-[10px] uppercase tracking-widest font-bold order-2 sm:order-1">
              © 2026 Vorix Intelligence. Todos os direitos reservados.
            </p>
            
            <div className="flex items-center gap-4 order-1 sm:order-2">
              <span className="text-[10px] font-bold text-white/40 uppercase tracking-widest mr-2">Siga-nos</span>
              <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-vorix-orange hover:border-vorix-orange/50 transition-all hover:scale-110">
